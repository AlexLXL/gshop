<template>
  <div class="shop-header">
    <nav class="shop-nav" :style="[bgImg]">
      <!-- <nav class="shop-nav"> -->
      <a class="back">
    ...
    <div class="shop-header-discounts" v-if="info.name" @click="isShowDiscounts = true">
    ...
    <!-- 这个是优惠 -->
    <div class="activity-sheet" v-if="isShowDiscounts">
      <div class="activity-sheet-content">
        ...
        <div class="activity-sheet-close">
          <span class="iconfont icon-close" @click="isShowDiscounts = false"></span>
        </div>
      </div>
...
export default {
  ...
  computed: {
    ...
    // 解决GET http://localhost:8080/shop/undefined 404 (Not Found)这个bug
    bgImg() {
      if (this.info.bgImg) {
        return { backgroundImage: `url(${this.info.bgImg})` };
      }
    }
  }
};
